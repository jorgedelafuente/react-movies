...
**Never call the real TMDB or Supabase APIs** — always mock with `page.route()` before navigating, using data from [src/tests/**mocks**/mocks.ts](src/tests/__mocks__/mocks.ts).
